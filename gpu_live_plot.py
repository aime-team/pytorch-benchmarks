...
def get_temperature_and_update_axes(
    ...
    for gpu_id in range(num_gpus):
        ...
        gpu_temp_list.append(int(gpu_temp))
        fan_speed_list.append(int(fan_speed))
        ...
        axis_gpu_temp_list[gpu_id].plot(time_list, gpu_temp_list, color='tab:red')
        axis_fan_speed_list[gpu_id].plot(time_list, fan_speed_list, color='tab:blue')
